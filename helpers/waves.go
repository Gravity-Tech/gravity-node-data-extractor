...
func (helper *ClientHelper) StateByAddressAndKey(address string, key string, ctx context.Context) (*State, *client.Response, error) {
...
func (helper *ClientHelper) StateByAddress(address string, ctx context.Context) ([]State, *client.Response, error) {
	url := fmt.Sprintf("%s/%s/%s", helper.client.GetOptions().BaseUrl, GetStateByAddressPath, address)
