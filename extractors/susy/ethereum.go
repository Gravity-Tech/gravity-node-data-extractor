...
func (provider *EthereumExtractionProvider) extractDirectRequest (ctx context.Context) (*extractors.Data, error) {
...
func (provider *EthereumExtractionProvider) extractReverseRequest (ctx context.Context) (*extractors.Data, error) {
	e := provider.ExtractorDelegate
